...
SELECT a.ID_FACT_SERVICIO,a.FK_DISTRIBUIDORA,a.FK_CLIENTE,a.FECHA,a.FECHA, b.FK_SERVICIO FROM FACT_SERVICIO a JOIN DET_FACT_SERVICIO b ON a.ID_FACT_SERVICIO=b.FK_FACT_SERVICIO
